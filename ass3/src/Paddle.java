...
public class Paddle implements Sprite, Collidable {
    ...
    public void moveLeft() {
        ...
        hitBox.setUpperLeft(x - MOVE_SENSITIVITY, y);
    }
    ...
    public void drawOn(DrawSurface d) {
        ...
        // The inside:
        d.setColor(color);
        d.fillRectangle((int) Math.round(upLeft.getX()),
                        (int) Math.round(upLeft.getY()), width, height);
        // The outline:
        d.setColor(Color.black);
        d.drawRectangle((int) Math.round(upLeft.getX()),
                (int) Math.round(upLeft.getY()), width, height);
    }
