...
public class Ball implements Sprite {
    ...
    public void moveOneStep() {
         ...
         */
        Line trajectory = new Line(center, new Point(x + 100000 * dx,
                y + 100000 * dy));
        ...
        if (collision != null) {
            ...
            if (Line.isLessThan(center.distance(collision.collisionPoint()),
                    speed)) {
                setVelocity(
                    collision.collisionObject().hit(collision.collisionPoint(),
                                velocity));
            }
        }
