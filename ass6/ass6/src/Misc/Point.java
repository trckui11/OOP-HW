...
/**
 * Class Shapes.Point describes points in the X-Y plane.
 * it has fields double x, y. These are the coordinates of a Shapes.Point.
 *
...
public class Point {
    ...
    public boolean equals(Point other) {
        ...
        return Line.isEqual(this.x, other.getX()) && Line.isEqual(this.y, other.getY());
    }
}
