...
/**
 * Class Shapes.Rectangle describes rectangles by their upper left vertex and their width and height.
 *
...
public class Rectangle {
    ...
    /**
     * Shapes.Rectangle constructor. Calculates the other vertices.
     *
     ...
     *
     * @param upLeftX the X coordinate of the upper left vertex setter.
     * @param upLeftY the Y coordinate of the upper left vertex setter.
     */
    public void setPosition(double upLeftX, double upLeftY) {
        this.upperLeft = new Point(upLeftX, upLeftY);
    ...
    public List<Point> intersectionPoints(Line line) {
        ...
        // Remove all the null points (no intersection):
        for (Point p : points) {
            if (p != null) {
                intersections.add(p);
            }
