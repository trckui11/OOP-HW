...
/**
 * Class Game.GameEnvironment holds all the collidables in the game environment.
 *
...
public class GameEnvironment {
    ...
    public CollisionInfo getClosestCollision(Line trajectory) {
        ...
        for (Collidable collidable : collidables) {
            Point closestInt = trajectory.closestIntersectionToStartOfLine(collidable.getCollisionRectangle());
        ...
        return new CollisionInfo(collisions.get(minDistIndex), collidables.get(minDistIndex));
    }
